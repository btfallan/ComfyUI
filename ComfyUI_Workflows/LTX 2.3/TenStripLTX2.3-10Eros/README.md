...
Info in workflows. 10S Nodes should now be on registry/manager. Update whenever a new workflow is uploaded.

Face ID i2v implementation from: https://huggingface.co/Alissonerdx/LTX-Best-Face-ID


LTX DMD Lora: https://huggingface.co/TenStrip/LTX2.3_DMD_Lora

LTX distilled Lora: https://huggingface.co/TenStrip/LTX2.3_Distilled_Lora_1.1_Experiments/tree/main
